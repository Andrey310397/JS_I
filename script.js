/*
    Abaixo de 16 Muito abaixo do peso
...
function calcular(event) {
    event.preventDefault(); //Prefenção do comportamento por padrão
    ...
    if (imc < 17) {
        ...
        resultado.innerHTML = '<br>Seu resultado foi: ' + imc.toFixed(2) + '<br> Você está com obesidade!';
    }
